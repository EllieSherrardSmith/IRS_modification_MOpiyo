####################################
##
## 3 Work out the probability that a feeding attempt by mosquito from species i ends in blood feeding on a person 
##
##
####################################################
...
plot(Estimated_propn_increase_EIR[,1] ~ time[1:180],ylim=c(0,1),pch="",
     ylab = "Proportional increase in EIR with lost IRS cover",
     col="black",
     main = "",cex.main=1.2,xlim=c(1,180),xaxt="n",
     xlab="Time in months",yaxt="n",cex.lab=1.4,cex.axis=1.4,cex=1.4)
