...
prop_mod_Acte_temp = c(0.891472868,0.81212081,0.639282555,
                       0.481047262,0.386204738,0.304873387,
                       0.166894353)

##And sorted for weeks:
prop_mod_Acte = c(rep(1,10),rep(prop_mod_Acte_temp,each=4))
## for time series of spray campaign
...
prop_mod_Sumi_temp = c(0.96460177,0.966330299,0.945153088,
                       0.923357485,0.917585479,0.904508888,
                       0.895619142)

##And sorted for weeks:
prop_mod_Sumi = c(rep(1,10),rep(prop_mod_Sumi_temp,each=4))
## for time series of spray campaign
